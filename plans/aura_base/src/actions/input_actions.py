...
@action_info(name="force_stop_app", public=True)
@requires_services(app="app")
def force_stop_app(app: AppProviderService, package_name: str, timeout_sec: float | None = None) -> dict:
    return app.force_stop_app(package_name, timeout_sec=timeout_sec)
